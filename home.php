...
<head>
    ...
    <meta content="Tour Guide Services" name="keywords">
    <meta content="Tour Guide Services" name="description">
...
<body>
        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 5;">
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="#" class="navbar-brand">
                    <h2 class="m-0 text-primary"><span class="text-dark">TRAVEL with</span> Olivier TourGuide</h2>
                </a>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="image/volcano.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Toursguide</h4>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="image/kaboo.jpeg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 500px;">
                            <h4 class="text-white text-uppercase mb-md-3">Tourguide</h4>
                            <h1 class="display-3 text-white mb-md-4">Discover Amazing Places With Olivier Tourguide</h1>
                            <a href="booking.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Book Now</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <form action="#" method="post">
                        <div class="input-group mb-3">
                            <input type="email" class="form-control bg-dark border-secondary" placeholder="Email address" required>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="text-muted small">Email: oliviertourguide250.com</p>
            ...
            <div class="row mt-5">
                <div class="col-12 text-center">
                    <p class="text-muted mb-0">© 2024 Olivier Tourguide. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/easing/1.4.1/jquery.easing.min.js"></script>
